...
```{r lyme-app, echo=FALSE, out.width="150%", fig.cap= "Lyme disease Shiny app. Apologies if it doesn't work - guess that's proof that Shiny hosting is super inconsistent."}
...
```{r rpm-app, echo=FALSE, out.width='150%'}
