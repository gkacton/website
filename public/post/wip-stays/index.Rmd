...
```{r header-image, echo=FALSE, out.width = "100%", fig.alt = "Close up of white stitching on tan linen."}
knitr::include_graphics("stitching.jpg")
```
...
```{r waist-tape, echo=FALSE, out.width='100%', fig.alt="Close up image of white stitching on tan linen. Focus is on the stays' waist reinforcement."}
knitr::include_graphics("waist_tape.jpg")
```
